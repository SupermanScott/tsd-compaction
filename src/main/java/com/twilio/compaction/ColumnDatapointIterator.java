...
final class ColumnDatapointIterator implements Comparable<ColumnDatapointIterator> {
   ...
   *
   * @param cell_timestamp Timestamp for the cell
   * @param qualifier Qualifier for the cell
   * @param value Value for the cell
   */
  public ColumnDatapointIterator(final long column_timestamp, final byte[] qualifier, final byte[] value) {
